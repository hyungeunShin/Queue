...
public class WaitingRoomController {
    ...
    public Mono<Rendering> waitingRoomPage(
            @RequestParam(name = "queue", defaultValue = "default") String queue, @RequestParam(name = "userId") Long userId
            , @RequestParam(name = "redirectUrl") String redirectUrl, ServerWebExchange exchange) {
